...
/**
 * Service interface class for the Mycourse object.
 * The implementation of this class is responsible for all business logic calls for the Mycourse object and is autowired by spring
...
public interface MycourseService {
     ...
     */
    public List<Mycourse> getMycourses(Context context, EPerson eperson) throws SQLException;
