...
/**
 * Database Access Object interface class for the Mycourse object.
 * The implementation of this class is responsible for all database calls for the Mycourse object and is autowired by spring
 * This class should only be accessed from a single service and should never be exposed outside of the API
 *
 * @author kevinvandevelde at atmire.com
 */
public interface MycourseDAO extends GenericDAO<Mycourse> {
