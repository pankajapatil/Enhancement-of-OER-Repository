...
{
    public MetadataValueDAOImpl()
    {
        super();
    }


	public List<MetadataValue> findAll(Context context) throws SQLException {
        return list(createQuery(context, "SELECT m FROM MetadataValue m"));
    }
