...
//change
    @Override
    public List<Collection> findMycourses(Context context,EPerson e) throws SQLException {
    	return collectionDAO.findCollectionInMycourses(context,e);
    }
    @Override
    public  List<Double> average(Context context,Collection collection) throws SQLException{
	return collectionDAO.avg(context,collection);
	}
    @Override
