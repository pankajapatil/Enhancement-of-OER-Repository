...
<script>
	...
	{
		var handle1=document.getElementById('h1').value;
		var handle2=document.getElementById('h2').value;
		

		if(document.getElementById("rating-1").checked)
			document.location.href='/rating?radio-value2=1&handle='+handle1+'/'+handle2;
		else if(document.getElementById("rating-2").checked)
			document.location.href='/rating?radio-value2=2&handle='+handle1+'/'+handle2;
		else if(document.getElementById("rating-3").checked)
			document.location.href='/rating?radio-value2=3&handle='+handle1+'/'+handle2;
		else if(document.getElementById("rating-4").checked)
			document.location.href='/rating?radio-value2=4&handle='+handle1+'/'+handle2;
		else if(document.getElementById("rating-5").checked)
			document.location.href='/rating?radio-value2=5&handle='+handle1+'/'+handle2;
...
<%
	...
	Integer x=handle.indexOf('/');
    String handle1=handle.substring(0,x);
    String handle2=handle.substring(x+1); 
    ...
    boolean rated = ((Boolean) request.getAttribute("rated")).booleanValue();
%>
<%   %>
...
<form >
  ...
  <input type="hidden" id="h1" value="<%= handle1%>"/>
  <input type="hidden" id="h2" value="<%= handle2%>"/>
  <input type="radio" id="rating-5" name="rating" value="5" onclick="handleClick()">
  <label for="rating-5"></label>
  <input type="radio" id="rating-4" name="rating" value="4" onclick="handleClick()">
  <label for="rating-4"></label>
  <input type="radio" id="rating-3" name="rating" value="3" onclick="handleClick()">
  <label for="rating-3"></label>
  <input type="radio" id="rating-2" name="rating" value="2" onclick="handleClick()">
  <label for="rating-2"></label>
  <input type="radio" id="rating-1" name="rating" value="1" onclick="handleClick()">
