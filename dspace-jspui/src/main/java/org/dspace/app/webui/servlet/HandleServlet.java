...
public class HandleServlet extends DSpaceServlet
{
	...
	RatingDAOImpl ratingDAO=new RatingDAOImpl();
	    if((ratingDAO.findByItemAndEPerson(context, context.getCurrentUser(), item) != null))
			request.setAttribute("rated", true);
	    else
			request.setAttribute("rated", false);	
            ...
            SQLException, AuthorizeException
    {
	    ...
	    List<Double> rating=collectionService.average(context,collection);
	    
	    request.setAttribute("rating",rating);
	    MycourseDAOImpl mycourseDAO=new MycourseDAOImpl();
	    if((mycourseDAO.findByCollectionAndEPerson(context, e, collection) != null))
